    ...
    "tasks": [
        {
            ...
            "python_wheel_task": {
                ...
                "named_parameters": {
                    "sourceBasePath": "s3://databricks-workspace-stack-8db8c-metastore-bucket/landing",
                    "pipelineBasePath": "s3://databricks-workspace-stack-8db8c-metastore-bucket/data",
                    "pipelineDatabase": "main.default"
                }
            },
            "existing_cluster_id": "0830-061257-we0uu6fn",
            "libraries": [
                {
